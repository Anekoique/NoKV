...
COPY tools/scripts/serve_from_config.sh /usr/local/bin/serve_from_config.sh
COPY tools/scripts/bootstrap_from_config.sh /usr/local/bin/bootstrap_from_config.sh
