...
#
# Usage:
#   tools/scripts/build_rocksdb.sh [--prefix DIR] [--branch <tag>] [--cmake-flags "<extra flags>"]
#   tools/scripts/build_rocksdb.sh --clean   # remove the build directory
#
...
Then run:
  ...
  go test -tags benchmark_rocksdb ./tools/bench -run TestBenchmarkYCSB -count=1
